...
C Northern Open Boundary
     ...
     &           / float(spongeThickness)
            IF (lambda_obcs_u.ne.0.) THEN
             lambda_obcs_u = 1.D0 / lambda_obcs_u
            ELSE
             lambda_obcs_u = 0.D0
            ENDIF
            gU_arr(i,j) = gU_arr(i,j)
     &           - maskW(i,j,k,bi,bj) * lambda_obcs_u
...
C Northern Open Boundary
     ...
     &           / float(spongeThickness)
            IF (lambda_obcs_v.ne.0.) THEN
             lambda_obcs_v = 1.D0 / lambda_obcs_v
            ELSE
             lambda_obcs_v = 0.D0
            ENDIF
            gV_arr(i,j) = gV_arr(i,j)
     &           - maskS(i,j,k,bi,bj) * lambda_obcs_v
...
C Northern Open Boundary
     ...
     &            / float(spongeThickness)
             IF (lambda_obcs_t.ne.0.) THEN
              lambda_obcs_t = 1.D0 / lambda_obcs_t
             ELSE
              lambda_obcs_t = 0.D0
             ENDIF
...
C Northern Open Boundary
     ...
     &            / float(spongeThickness)
             IF (lambda_obcs_s.ne.0.) THEN
              lambda_obcs_s = 1.D0 / lambda_obcs_s
             ELSE
              lambda_obcs_s = 0.D0
             ENDIF

...
C--   Default flags and values for OBCS
      ...
      OBCS_balanceFacN   = 1.D0
      OBCS_balanceFacS   = 1.D0
      OBCS_balanceFacE   = 1.D0
      OBCS_balanceFacW   = 1.D0
      OBCS_u1_adv_T      = 0
      OBCS_u1_adv_S      = 0
      useOBCSprescribe   =.FALSE.
      OBCSfixTopo        =.FALSE.
      OBCS_uvApplyFac    = 1.D0
...
C     sponge layer is turned off by default
      spongeThickness = 0
      Urelaxobcsinner = 0.D0
      Urelaxobcsbound = 0.D0
      Vrelaxobcsinner = 0.D0
      Vrelaxobcsbound = 0.D0
CML this was the previous default in units of days
CML      spongeThickness = 2
CML      Urelaxobcsinner = 5.D0
CML      Urelaxobcsbound = 1.D0
CML      Vrelaxobcsinner = 5.D0
CML      Vrelaxobcsbound = 1.D0
      IF (useOBCSsponge)

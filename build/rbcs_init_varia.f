      ...
      DO bj = myByLo(myThid), myByHi(myThid)
        DO bi = myBxLo(myThid), myBxHi(myThid)
          ...
          DO k=1,Nr
            DO j=1-Oly,sNy+OLy
              DO i=1-Olx,sNx+Olx
                rbcu0(i,j,k,bi,bj) = 0.D0
                rbcv0(i,j,k,bi,bj) = 0.D0
                rbcu1(i,j,k,bi,bj) = 0.D0
                rbcv1(i,j,k,bi,bj) = 0.D0
                RBCuVel(i,j,k,bi,bj) = 0.D0
                RBCvVel(i,j,k,bi,bj) = 0.D0
                rbct0(i,j,k,bi,bj) = 0.D0
                rbcs0(i,j,k,bi,bj) = 0.D0
                rbct1(i,j,k,bi,bj) = 0.D0
                rbcs1(i,j,k,bi,bj) = 0.D0
                RBCtemp(i,j,k,bi,bj) = 0.D0
                RBCsalt(i,j,k,bi,bj) = 0.D0
              ENDDO
            ENDDO
          ENDDO
        ENDDO
           ...
           DO k=1,Nr
             DO j=1-Oly,sNy+OLy
               DO i=1-Olx,sNx+Olx
                ...
                RBC_ptracers(i,j,k,bi,bj,iTracer) = 0.D0
               ENDDO
              ENDDO
            ENDDO
          ENDDO

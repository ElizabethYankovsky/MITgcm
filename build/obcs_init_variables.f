       ...
       DO bi = myBxLo(myThid), myBxHi(myThid)
        ...
        DO k=1,Nr
         DO i=1-Olx,sNx+Olx
          ...
          OBNt(i,k,bi,bj)=0.D0
          OBNs(i,k,bi,bj)=0.D0
          OBNu0(i,k,bi,bj)=0.D0
          OBNv0(i,k,bi,bj)=0.D0
          OBNt0(i,k,bi,bj)=0.D0
          OBNs0(i,k,bi,bj)=0.D0
          OBNu1(i,k,bi,bj)=0.D0
          OBNv1(i,k,bi,bj)=0.D0
          OBNt1(i,k,bi,bj)=0.D0
          OBNs1(i,k,bi,bj)=0.D0

          OBSu(i,k,bi,bj)=0.D0
          OBSv(i,k,bi,bj)=0.D0
          OBSt(i,k,bi,bj)=0.D0
          OBSs(i,k,bi,bj)=0.D0
          OBSu0(i,k,bi,bj)=0.D0
          OBSv0(i,k,bi,bj)=0.D0
          OBSt0(i,k,bi,bj)=0.D0
          OBSs0(i,k,bi,bj)=0.D0
          OBSu1(i,k,bi,bj)=0.D0
          OBSv1(i,k,bi,bj)=0.D0
          OBSt1(i,k,bi,bj)=0.D0
          OBSs1(i,k,bi,bj)=0.D0
         ENDDO
         ...
         DO j=1-Oly,sNy+Oly
          ...
          OBEt(j,k,bi,bj)=0.D0
          OBEs(j,k,bi,bj)=0.D0
          OBEu0(j,k,bi,bj)=0.D0
          OBEv0(j,k,bi,bj)=0.D0
          OBEt0(j,k,bi,bj)=0.D0
          OBEs0(j,k,bi,bj)=0.D0
          OBEu1(j,k,bi,bj)=0.D0
          OBEv1(j,k,bi,bj)=0.D0
          OBEt1(j,k,bi,bj)=0.D0
          OBEs1(j,k,bi,bj)=0.D0

          OBWu(j,k,bi,bj)=0.D0
          OBWv(j,k,bi,bj)=0.D0
          OBWt(j,k,bi,bj)=0.D0
          OBWs(j,k,bi,bj)=0.D0
          OBWu0(j,k,bi,bj)=0.D0
          OBWv0(j,k,bi,bj)=0.D0
          OBWt0(j,k,bi,bj)=0.D0
          OBWs0(j,k,bi,bj)=0.D0
          OBWu1(j,k,bi,bj)=0.D0
          OBWv1(j,k,bi,bj)=0.D0
          OBWt1(j,k,bi,bj)=0.D0
          OBWs1(j,k,bi,bj)=0.D0
         ENDDO
        ENDDO
        ...
        DO k=1,Nr
         DO i=1-Olx,sNx+Olx
          OBNw (i,k,bi,bj) = 0.D0
          OBSw (i,k,bi,bj) = 0.D0
          OBNw0(i,k,bi,bj) = 0.D0
          OBSw0(i,k,bi,bj) = 0.D0
          OBNw1(i,k,bi,bj) = 0.D0
          OBSw1(i,k,bi,bj) = 0.D0
         ENDDO
         DO j=1-Oly,sNy+Oly
          OBEw (j,k,bi,bj) = 0.D0
          OBWw (j,k,bi,bj) = 0.D0
          OBEw0(j,k,bi,bj) = 0.D0
          OBWw0(j,k,bi,bj) = 0.D0
          OBEw1(j,k,bi,bj) = 0.D0
          OBWw1(j,k,bi,bj) = 0.D0
         ENDDO
        ENDDO
...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
        ...
        IF ( usePTRACERS ) THEN
         DO iTracer=1,PTRACERS_numInUse
          DO k=1,Nr
           DO i=1-Olx,sNx+Olx
            OBNptr (i,k,bi,bj,iTracer)=0.D0
            OBNptr0(i,k,bi,bj,iTracer)=0.D0
            OBNptr1(i,k,bi,bj,iTracer)=0.D0

            OBSptr (i,k,bi,bj,iTracer)=0.D0
            OBSptr0(i,k,bi,bj,iTracer)=0.D0
            OBSptr1(i,k,bi,bj,iTracer)=0.D0
           ENDDO

           DO j=1-Oly,sNy+Oly
            OBEptr (j,k,bi,bj,iTracer)=0.D0
            OBEptr0(j,k,bi,bj,iTracer)=0.D0
            OBEptr1(j,k,bi,bj,iTracer)=0.D0

            OBWptr (j,k,bi,bj,iTracer)=0.D0
            OBWptr0(j,k,bi,bj,iTracer)=0.D0
            OBWptr1(j,k,bi,bj,iTracer)=0.D0
           ENDDO
          ENDDO
         ENDDO
        ENDIF

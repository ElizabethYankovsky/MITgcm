...
C   OBW_connect      :: domain connected piece Id of this Western OB grid point
     ...
     &  OB_indexNone, OBCS_indexStatus
      ...
      COMMON /OBCS_MASK_RS/
     &  OBCS_insideMask
      Real*8 OBCS_insideMask(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C    bi, bj    :: indices of current tile
      ...
      Real*8 cflMer               (1-OLy:sNy+OLy,Nr)
      Real*8 gFacM                (1-OLy:sNy+OLy,Nr)
      Real*8 gammaf, pFac, aFac
      Real*8 OBEf                 (1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 OBE_Stevens          (1-Oly:sNy+Oly,Nr,nSx,nSy)
...
C    bi, bj    :: indices of current tile
      ...
      Real*8 gFacM                (1-OLy:sNy+OLy,Nr)
      Real*8 gammaf, pFac, aFac
      Real*8 OBWf                 (1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 OBW_Stevens          (1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 tracer (1-Olx:sNx+Olx,1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 uVel   (1-Olx:sNx+Olx,1-Oly:sNy+Oly,Nr,nSx,nSy)
...
C    bi, bj    :: indices of current tile
      ...
      Real*8 cflZon               (1-OLx:sNx+OLx,Nr)
      Real*8 gFacZ                (1-OLx:sNx+OLx,Nr)
      Real*8 gammaf, pFac, aFac
      Real*8 OBNf                 (1-Olx:sNx+Olx,Nr,nSx,nSy)
      Real*8 OBN_Stevens          (1-Olx:sNx+Olx,Nr,nSx,nSy)
      Real*8 tracer (1-Olx:sNx+Olx,1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 vVel   (1-Olx:sNx+Olx,1-Oly:sNy+Oly,Nr,nSx,nSy)
...
C    bi, bj    :: indices of current tile
      ...
      Real*8 gFacZ                (1-OLx:sNx+OLx,Nr)
      Real*8 gammaf, pFac, aFac
      Real*8 OBSf                 (1-Olx:sNx+Olx,Nr,nSx,nSy)
      Real*8 OBS_Stevens          (1-Olx:sNx+Olx,Nr,nSx,nSy)
      Real*8 tracer (1-Olx:sNx+Olx,1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 vVel   (1-Olx:sNx+Olx,1-Oly:sNy+Oly,Nr,nSx,nSy)

...
C     msgBuf       :: Informational/error message buffer
      ...
      Real*8 areaOB, areaE, areaW, areaN, areaS, tmpA
      Real*8 inFlow, flowE, flowW, flowN, flowS
      Real*8 tileArea(nSx,nSy)
      Real*8 tileFlow(nSx,nSy)
      Real*8 tileAreaOB(nSx,nSy)
      Real*8 tileInFlow(nSx,nSy)
      LOGICAL flag
      Real*8 netFreshWaterFlux
      Real*8 shelfIceNetMassFlux
...
C     displacement fluxes from advancing ice sheets or imported sea ice
      ...
      netFreshWaterFlux = 0.D0
      shelfIceNetMassFlux = 0.D0

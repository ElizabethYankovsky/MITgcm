...
C     aWght, bWght :: Interpolation weights
C     myThid       :: my Thread Id. number
      Real*8 fld (1-Olx:sNx+Olx,Nr,nSx,nSy)
      Real*8 fld0(1-Olx:sNx+Olx,Nr,nSx,nSy)
      Real*8 fld1(1-Olx:sNx+Olx,Nr,nSx,nSy)
      Real*8 aWght,bWght
      INTEGER myThid
...
C     aWght, bWght :: Interpolation weights
C     myThid       :: my Thread Id. number
      Real*8 fld (1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 fld0(1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 fld1(1-Oly:sNy+Oly,Nr,nSx,nSy)
      Real*8 aWght,bWght
      INTEGER myThid
